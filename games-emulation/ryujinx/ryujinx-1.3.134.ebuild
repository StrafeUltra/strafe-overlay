...
PATCHES=( "${FILESDIR}/${PN}-better-defaults.patch" )
...
src_install() {
	# Workarounds: gentoo#933075 and upstream#5566
	dotnet-pkg-base_append-launchervar "GDK_BACKEND=x11"
	dotnet-pkg-base_install

	# Ensure launcher script is installed regardless of RID (gentoo#923817)
	exeinto "/usr/share/${P}"
